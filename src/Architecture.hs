...
-- annotatedPlan :: Diagram B
-- annotatedPlan = mconcat [brick, perim # translateX 20, hgt, tierA, tierB, tierC, width, height, centerXY plan] # connectPerim' astyle "channel inset" "channel" (270 @@ deg) (90 @@ deg) # connect' astyle "thickening label" "channel"
--   where
